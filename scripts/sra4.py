"""
Convert any Fox at Walton SRA4 menu HTML to a print-ready PDF.

Usage:
    python3 convert_sra4.py <input.html>           # outputs <input>.pdf
    python3 convert_sra4.py <input.html> <out.pdf> # outputs to specified path

Key settings:
- Exact page size: 225mm x 320mm (SRA4)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 convert_sra4.py <input.html> [output.pdf]")
        sys.exit(1)
